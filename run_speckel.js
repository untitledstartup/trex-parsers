...
var genstringsMacro = "tr";
var genstringsLanguage = "ruby";
var folderPath = '../speckel/app'; // The relative folder path which contains the files you want to parse
var filePathFilter = ['**/*.haml', '**/*.hamlbars', '**/*.rb', '**/*.js.*', '**/*.rb.*']; // File path filters, is passed into `fs.recurseSync` see https://www.npmjs.com/package/file-system#recursesyncdirpath-filter-callback

...
// TokenParser
  ...
  TokenParser.prototype.informInterpolatedString = function informInterpolatedString(token) {
    var interpNodes = GSUtils.filterNodes(token.node, function(n) {
      return n.ctorName == "stringInterpolation";
    });
    var description = null;
    if (interpNodes && interpNodes.length > 0) {
      description = GSUtils.debugDescriptionForNode(interpNodes[0]);
    }
    else {
